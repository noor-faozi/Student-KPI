...
<body>
    ...
    <section class="sec-2" id="sec-2">
        <h2 style="padding: 10px;">KPI Activities Managment</h2>
        ...
        <div style="padding: 10px;" id="kpi">
            <div class="table-container">
                ...
                <table border="1" width="100%" class="kpi" id="projectable" style="overflow-x: auto;">
                    ...
                    <?php
            $sql = "SELECT * FROM kpiactivity WHERE userID=" . $_SESSION["UID"];
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td>" . $numrow . "</td><td>" . $row["semYear"] . "</td><td>" . $row["name"] . "</td><td>" . getActivityTypeDescription($row["type"]) . "</td><td>" . $row["remark"] .
                        "</td><td> <a class='editBtn' href='activities_management_edit.php?id=" . $row["id"] . "'>Edit</a>&nbsp;|&nbsp;";
                    echo '<a class="deleteBtn" href="activities_management_delete.php?id=' . $row["id"] . '" onClick="return confirm(\'Delete?\');">Delete</a> </td>';
                    echo "</tr>" . "\n\t\t";
                    $numrow++;
                }
            } else {
            ...
            function getActivityTypeDescription($type)
            {
                switch ($type) {
                    case 1:
                        return 'Faculty';
        ...
        <div style="padding:0 10px;" id="kpiDiv">
            <h3 align="center">Add Kpi Activity</h3>
            <p align="center" style="color: red;">Required field with mark*</p>

            <form method="POST" action="activities_management_action.php" enctype="multipart/form-data" id="myForm">
                <div id="inputForm">
                    ...
                    <label for="type">Activity Type*</label>
                        <select size="1" id="myInput" name="type" required>
                            <option value="1">Faculty Activity</option>
                            <option value="2">University Activity</option>
                            <option value="3">National Activity</option>
                            <option value="4">International Activity</option>
                        </select>
