...
<body>
    ...
    <section class="sec-2" id="sec-2">
        ...
        <div style="padding: 10px;" id="challenge">
            <div style="text-align: center; padding:10px;">
                <form action="my_challenge_search.php" method="post">
                    <div style="text-align: center; padding-top:10px;">
                        <div class="searchWrapper">
                            <input type="text" name="search" id="search" onkeyup="searchFunction()" placeholder="Search for challenges.." title="Type in a challenge">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if (!empty($row["img_path"])) {
                                    echo "<img src='uploads/" . $row["img_path"] . "' width='150' height='100'>";
                                }
                        
                                echo "</td>";
                                echo '<td> <a class="editBtn" href="my_challenge_edit.php?id=' . $row["ch_id"] . '">Edit</a>&nbsp;|&nbsp;';
                                echo '<a class="deleteBtn" href="my_challenge_delete.php?id=' . $row["ch_id"] . '&img_path=' . $row["img_path"] . '" onClick="return confirm(\'Delete?\');">Delete</a> </td>';
                                echo "</tr>" . "\n\t\t";
                                $numrow++;
                            }
                        } else {
            ...
            <form method="POST" action="my_challenge_action.php" enctype="multipart/form-data" id="myForm">
                <div id="inputForm">
                    ...
                    <label>Challenge*</label>
                        <textarea rows="4" name="challenge" cols="20" required id="myInput"></textarea>
                    <label>Plan*</label>
                        <textarea rows="4" name="plan" cols="20" required id="myInput"></textarea>
                    <label>Remark</label>
