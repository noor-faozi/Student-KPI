...
<body>
    ...
    <section class="sec-2" id="sec-2">
        <h2 style="padding: 10px;">KPI Certificates Management</h2>
        ...
        <div style="padding: 10px;" id="kpi">
            <div class="table-container">
                ...
                <table border="1" width="100%" class="kpi" id="projectable" style="overflow-x: auto;">
                    ...
                    <?php
                    $sql = "SELECT * FROM kpicertificate WHERE userID=" . $_SESSION["UID"];
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>";
                            echo "<td>" . $numrow . "</td><td>" . $row["semYear"] . "</td><td>" . $row["name"] . "</td><td>" . $row["remark"] .
                                "</td><td> <a class='editBtn' href='certification_management_edit.php?id=" . $row["id"] . "'>Edit</a>&nbsp;|&nbsp;";
                            echo '<a class="deleteBtn" href="certification_management_delete.php?id=' . $row["id"] . '" onClick="return confirm(\'Delete?\');">Delete</a> </td>';
                            echo "</tr>" . "\n\t\t";
                            $numrow++;
                        }
                    } else {
        ...
        <div style="padding:0 10px;" id="kpiDiv">
            <h3 align="center">Add KPI Certificate</h3>
            <p align="center" style="color: red;">Required field with mark*</p>

            <form method="POST" action="certification_management_action.php" enctype="multipart/form-data" id="myForm">
                <div id="inputForm">
                    ...
                    <label>Semester and Year*<label>
                            ...
                            <label class="indicator">Certificates</label>
