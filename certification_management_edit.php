...
<body onLoad="show_AddEntry()">
    ...
    <section class="sec-2" id="sec-2">
        ...
        <h2 style="padding: 10px;">List of KPI Certificates</h2>
        ...
        if (isset($_GET["id"]) && $_GET["id"] != "") {
            $id = $_GET["id"];
            $userID = $_SESSION["UID"];
            $sql = "SELECT * FROM kpicertificate WHERE id = ? AND userID = ?";
            $stmt = mysqli_prepare($conn, $sql);
        ...
        <div style="padding: 10px;" id="kpiDiv">
            <h3 align="center">Edit KPI Certificate</h3>
            <p align="center" style="color: red;">Required fields are marked*</p>

            <form method="POST" action="certification_management_edit_action.php" enctype="multipart/form-data" id="myForm">
                <div id="inputForm">
                    <input type="hidden" id="kcrid" name="kcrid" value="<?= $_GET['id'] ?>">
